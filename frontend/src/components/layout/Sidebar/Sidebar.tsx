...
const navigationItems: NavigationItem[] = [
  ...
  },
  {
    ...
    icon: Integration,
    children: [
      { id: 'calendar', label: 'Calendar', path: '/integrations/calendar', icon: Integration },
      { id: 'video', label: 'Video', path: '/integrations/video', icon: Integration },
      { id: 'webhooks', label: 'Webhooks', path: '/integrations/webhooks', icon: Integration },
    ],
  },
  {
    id: 'notifications',
